...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 28 2024 г., 18:11
...
CREATE TABLE `edu_paid_orders` (
  ...
  `teacher_salary_id` bigint(20) DEFAULT NULL,
  `remain_hours` decimal(11,0) DEFAULT 0,
...
--
-- Структура таблицы `group_orders`
--
...
CREATE TABLE `journals` (
  ...
  `date` date NOT NULL,
  `salary_check` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(15, '2024_02_25_204452_create_groups_table', 10),
(17, '2024_02_25_205916_create_group_students_table', 11),
(19, '2024_02_25_161930_create_schedules_table', 12),
(20, '2024_02_26_212818_create_teacher_salaries_table', 13),
(21, '2024_03_01_112500_create_expenses_table', 14),
(22, '2024_03_04_164123_create_group_orders_table', 15),
(23, '2024_03_07_212230_create_card_orders_table', 16),
(24, '2024_03_16_192348_create_logs_table', 17),
(25, '2024_03_19_211753_create_journals_table', 18);
...
CREATE TABLE `users` (
  ...
  `start_edu_date` date DEFAULT NULL,
  `penalty` int(11) NOT NULL DEFAULT 0,
  `bonus` int(11) NOT NULL DEFAULT 0,
...
INSERT INTO `users` (`id`, `iin`, `name`, `s_name`, `fio`, `birthday`, `tel_num`, `password`, `real_password`, `tel_num_family`, `avatar`, `is_deleted`, `filial_id`, `role_id`, `start_edu_date`, `penalty`, `bonus`, `card_id`) VALUES
(1, '020914500302', 'Аслан', 'Асанұлы', 'Асанұлы Аслан', '2002-09-14', '+7(775) 549-89-11', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'password', '+7(775) 549-89-12', 'avatars/1708858305_CPBz5.jpg', 0, 2, 1, '2024-02-29', 0, 0, NULL);
...
--
-- AUTO_INCREMENT для таблицы `card_orders`
--
ALTER TABLE `card_orders`
...
--
-- AUTO_INCREMENT для таблицы `group_orders`
--
ALTER TABLE `group_orders`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
