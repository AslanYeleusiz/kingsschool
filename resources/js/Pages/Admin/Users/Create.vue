                ...
                <form method="post" @submit.prevent="submit">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" v-model="user.s_name" name="s_name" placeholder="Фамилия" required />
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Имя</label>
                                    <input type="text" class="form-control" v-model="user.name" name="name" placeholder="Имя" required />
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" v-model="user.birthday" name="birthday" placeholder="Фамилия" required />
                        ...
                        <div class="form-group file-upload">
                            ...
                            <div class="ml-2">
                                <img v-if="user.image && !image.file" :src="route('index')  +'/storage/images/' +  user.image" height="300" alt="image" style="padding-bottom: 10px" />
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" @change.prevent="calculatePrice(index)" v-model="eduOrder.subject_id" placeholder="Выбрать" required>
                                            ...
                                            <option v-for="subject in subjects" :key="'subject' + subject.id" :value="subject.id">
                                                {{subject.name}}
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" v-model="eduOrder.teacher_id" placeholder="Выбрать" required>
                                            <option value="" hidden>
                                                Выбрать
                                            </option>
                                            <option v-for="teacher in teachers" :key="'teacher' + teacher.id" :value="teacher.id">
                                                {{teacher.fio}}
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" @change.prevent="calculatePrice(index)" v-model="eduOrder.course_type_id" placeholder="Выбрать" required>
                                            <option :value="null" hidden>
                                                Выбрать
                                            </option>
                                            <option v-for="courseType in courseTypes" :key="'courseType' + courseType.id" :value="courseType.id">
                                                {{courseType.name}}
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" @change.prevent="calculatePrice(index)" v-model="eduOrder.train_type_id" placeholder="Выбрать" required>
                                            <option :value="null" hidden>
                                                Выбрать
                                            </option>
                                            <option v-for="trainType in trainTypes" :key="'trainType' + trainType.id" :value="trainType.id">
                                                {{trainType.name}}
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" v-model="eduOrder.price" name="eduOrderPrice" placeholder="Цена" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" @change.prevent="add28Days(index)" v-model="eduOrder.start_date" name="eduOrderPrice" required />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">Дата конца обучения</label>
                                        <input type="date" class="form-control" v-model="eduOrder.end_date" name="eduOrderPrice" required />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div v-for="teacherOrder in teacherOrders" class="input-group mt-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon3">{{teacherOrder.name}}</span>
                                        </div>
                                        <input type="number" class="form-control" v-model="teacherOrder.percent" aria-describedby="basic-addon3" style="text-align: right;" required />
